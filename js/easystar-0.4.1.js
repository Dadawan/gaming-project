	...
	EasyStar.js = function () {
	    ...
	    **/
	    this.setAcceptableTiles = function (tiles) {
	        if (tiles instanceof Array) {
	            // Array
	            //acceptable tiles are 0, 4, 5, 8, 9, 6, 7, 5 depending on context of position and direction heading 
	            //if char is in 0tile, can't move into 4 tile from below...
	            //when moving (calculate path but can't stop/land on ally or enemy square), if current character is in 4tile or another character enemy or ally is in, (pushed, moved imposed on), can't move into 9tile, 8tile, 
	            //if in tile4, 
	    ...
	    **/
	    this.avoidAdditionalPoint = function (x, y) {
	        ...
	        pointsToAvoid[y][x] = 1;
	        //if [x, y] if array[1][3] since reverse === 4 || 8, then update pointsToAvoid array with 9. if current array is not 4, toggle remove 9
	        // if array[][] === 8, avoid 4, 5, 9
	    };
	    ...
	    **/
	    ...
	    var calculateDirection = function (diffX, diffY) {
	    	//this is where calculate direction to move, so if in level
